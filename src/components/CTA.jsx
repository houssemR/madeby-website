        ...
        <div className="cta-inner reveal">
          ...
          <div className="cta-content">
            ...
            <p className="cta-sub">
              ...
              in your language, with your mascot cheering you on.
            </p>
            <div className="cta-btns">
              <a href="https://apps.apple.com/app/id6792596703" target="_blank" rel="noopener" className="btn btn-ghost cta-btn">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.craftmadeby.app" target="_blank" rel="noopener" className="btn btn-ghost cta-btn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
